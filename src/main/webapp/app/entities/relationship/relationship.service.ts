...
export class RelationshipService {
    ...
    private resourceUrl = 'api/relationships';
    ...
    find(id: number): Observable<Relationship> {
    ...
    private convert(relationship: Relationship): Relationship {
        ...
        copy.createDateTime = this.dateUtils.toDate(relationship.createDateTime);

        copy.updateDateTime = this.dateUtils.toDate(relationship.updateDateTime);
        return copy;
    }
}
