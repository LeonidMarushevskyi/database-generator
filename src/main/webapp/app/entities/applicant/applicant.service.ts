...
export class ApplicantService {
    ...
    private resourceUrl = 'api/applicants';
    ...
    find(id: number): Observable<Applicant> {
    ...
    private convert(applicant: Applicant): Applicant {
        ...
        copy.createDateTime = this.dateUtils.toDate(applicant.createDateTime);

        copy.updateDateTime = this.dateUtils.toDate(applicant.updateDateTime);
        return copy;
    }
}
