...
export class HouseholdService {
    ...
    private resourceUrl = 'api/households';
    ...
    find(id: number): Observable<Household> {
    ...
    private convert(household: Household): Household {
        const copy: Household = Object.assign({}, household);

        copy.createDateTime = this.dateUtils.toDate(household.createDateTime);

        copy.updateDateTime = this.dateUtils.toDate(household.updateDateTime);
        return copy;
    }
}
